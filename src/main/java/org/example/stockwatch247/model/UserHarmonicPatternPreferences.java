...
@Entity
@Table(name = "user_harmonic_pattern_preferences", uniqueConstraints =
        @UniqueConstraint(name = "uk_user_harmonic_pattern_preferences_user", columnNames = "user_id"))
public class UserHarmonicPatternPreferences {
    @Id
