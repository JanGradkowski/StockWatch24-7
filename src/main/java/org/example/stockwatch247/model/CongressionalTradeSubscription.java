...
@Entity
@Table(name = "congressional_trade_subscriptions", uniqueConstraints = {
        @UniqueConstraint(
                name = "uk_congressional_subscription_user_asset",
                columnNames = {"user_id", "stock_asset_id"})
})
public class CongressionalTradeSubscription {
    ...
    public Instant getBaselineCompletedAt() {
        return baselineCompletedAt;
    }
    ...
    public void setBaselineCompletedAt(Instant baselineCompletedAt) {
