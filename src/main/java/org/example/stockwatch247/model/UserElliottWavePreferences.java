...
@Entity
@Table(name = "user_elliott_wave_preferences", uniqueConstraints =
        @UniqueConstraint(name = "uk_user_elliott_wave_preferences_user", columnNames = "user_id"))
public class UserElliottWavePreferences {
    @Id
